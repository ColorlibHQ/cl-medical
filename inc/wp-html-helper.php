...
// image default alt
if( ! function_exists( 'medical_img_default_alt' ) ) {
	function medical_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'medical_img_tag' ) ) {
	function medical_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = medical_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'medical_anchor_tag' ) ) {
	function medical_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'medical' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'medical_heading_tag' ) ) {
	function medical_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'medical' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'medical_paragraph_tag' ) ) {
	function medical_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'medical_other_tag' ) ) {
	function medical_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'medical_button_element ' ) ) {
	function medical_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'medical' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
