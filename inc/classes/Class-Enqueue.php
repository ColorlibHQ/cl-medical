...
class Medical_Enqueue {

	public $scripts = array();

	public function medical_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'medical_frontend_enqueue_scripts', ) );
	}

	public function medical_frontend_enqueue_scripts( ) {
