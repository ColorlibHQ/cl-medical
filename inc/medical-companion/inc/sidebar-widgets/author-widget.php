...
class medical_author_widget extends WP_Widget {
...
'medical_author_widget',


// Widget name will appear in UI
esc_html__( '[ Medical ] Author Widget', 'medical' ),

// Widget description
array( 'description' => esc_html__( 'Add author content', 'medical' ), )
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Author Name', 'medical' );
}
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'designation' ) ); ?>"><?php esc_html_e( 'Designation:' ,'medical'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'textarea' ) ); ?>"><?php esc_html_e( 'Short Descriptions:' ,'medical'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Facebook Url' ) ); ?>"><?php esc_html_e( 'Facebook Url:' ,'medical'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Twitter Url' ) ); ?>"><?php esc_html_e( 'Twitter Url:' ,'medical'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Dribbble Url' ) ); ?>"><?php esc_html_e( 'Dribbble Url:' ,'medical'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Behance Url' ) ); ?>"><?php esc_html_e( 'Behance Url:' ,'medical'); ?></label>
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>"><?php _e( 'Image', 'medical' ); ?>:</label>
	<div class="medical-media-container">
		<div class="medical-media-inner">
			...
			<span class="medical-no-image" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-noimg" <?php echo wp_kses_post( $no_img_style ); ?>><?php _e( 'No image selected', 'medical' ); ?></span>
		</div>
	
	<input type="text" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'image' ) ); ?>" value="<?php echo esc_attr( $image ); ?>" class="medical-media-url" />

	<input type="button" value="<?php echo _e( 'Remove', 'medical' ); ?>" class="button medical-media-remove" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-remove" <?php echo wp_kses_post( $img_style ); ?> />

	<?php $button_text = ( $image != '' ) ? __( 'Change Image', 'medical' ) : __( 'Select Image', 'medical' ); ?>
	<input type="button" value="<?php echo esc_html( $button_text ); ?>" class="button medical-media-upload" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-button" />
	<br class="clear">
	</div>
</p>
<style>
.medical-media-container {
	width: 98%;
}
...
jQuery(function($){
    ...
    wpshed_image_upload( '.medical-media-upload' );
    ...
    wpshed_image_remove( '.medical-media-remove' );
...
} // Class medical_author_widget ends here


// Register and load the widget
function medical_author_load_widget() {
	register_widget( 'medical_author_widget' );
}
add_action( 'widgets_init', 'medical_author_load_widget' );