	...
	private function _notify_feedback() {
		...
		$html .=
			vsprintf(
				...
				__( 'We\'ve been working hard on making %1$s the best one out there. We\'re interested in hearing your thoughts about %1$s and what we could do to make it even better. %2$sSend your feedback our way%3$s.', 'medical' ),
				array(
					'medical',
